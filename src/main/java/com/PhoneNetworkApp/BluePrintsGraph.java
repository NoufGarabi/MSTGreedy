...
The BluePrintsGraph class represents a graph specifically designed for blueprints.
*/
...
Reads a graph from a file with the given filename and constructs a BluePrintsGraph object.
