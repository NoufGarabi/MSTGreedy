 ...
 * @param isDirected Specifies whether the graph is directed (true) or undirected (false).
 */
...
/**
 * Creates a new Edge object between the given source and target vertices with the given weight.
 *
 * @param vertex  The source vertex of the edge.
 * @param vertex2 The target vertex of the edge.
 * @param weight  The weight of the edge.
 ...
 * @return The Edge object representing the edge between the source and target vertices, or null if not found.
 */
 ...
 * @return The weight of the edge between the source and target vertices, or -1 if there is no edge between them.
 */
 ...
 * @return true if there is an edge between the source and target vertices, false otherwise.
 */
